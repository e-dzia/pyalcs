...
if __name__ == "__main__":
    ...
    metrics_ap = plot_handeye_mean(
        number_of_tests, env_name, 'mean_results/x_{}_ap_{}_{}.pdf'
    ...
    #     number_of_tests, env_name, 'mean_results/x_{}_no_ap_{}_{}.pdf'.
    ...
    # plot_with_without_ap('mean_results/x_{}_both_{}_{}.pdf'.format(
    #     env_name, number_of_tests, start), metrics_ap, metrics_no_ap)

    metrics_ap.to_csv('mean_results/x_{}_ap_{}_{}.csv'.
                      format(env_name, number_of_tests, start).
                      replace(' ', '_').replace(":", "-"))

    # metrics_no_ap.to_csv('mean_results/x_{}_no_ap_{}_{}.csv'.
    #                      format(env_name, number_of_tests, start).
    #                      replace(' ', '_').replace(":", "-"))
